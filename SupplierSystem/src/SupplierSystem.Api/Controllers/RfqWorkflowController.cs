...
public sealed partial class RfqWorkflowController(
    ...
    RfqComparisonPrintService rfqComparisonPrintService,
    ...
    ILogger<RfqWorkflowController> logger) : ControllerBase
{
    ...
    private readonly RfqWorkflowStore _rfqWorkflowStore = rfqWorkflowStore;
    private readonly RfqComparisonPrintService _rfqComparisonPrintService = rfqComparisonPrintService;
