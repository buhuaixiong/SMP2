...
public sealed partial class OrganizationalUnitsController
{
    ...
    public async Task<IActionResult> CreateUnit([FromBody] JsonElement body, CancellationToken cancellationToken)
    {
        ...
        var codeExists = await _organizationalUnitDataService.QueryUnits()
        ...
        {
            parent = await _organizationalUnitDataService.QueryUnits()
        ...
        _organizationalUnitDataService.AddUnit(unit);

        try
        {
            await _organizationalUnitDataService.SaveChangesAsync(cancellationToken);
        }
    ...
    public async Task<IActionResult> UpdateUnit(int id, [FromBody] JsonElement body, CancellationToken cancellationToken)
    {
        ...
        var unit = await _organizationalUnitDataService.QueryUnits(asNoTracking: false)
        ...
        var memberCount = await _organizationalUnitDataService.QueryMembers()
    ...
    public async Task<IActionResult> CheckDeletion(int id, CancellationToken cancellationToken)
    {
        ...
        var childUnits = await _organizationalUnitDataService.QueryUnits()
    ...
    public async Task<IActionResult> MoveUnit(int id, [FromBody] JsonElement body, CancellationToken cancellationToken)
    {
        ...
        var allUnits = await _organizationalUnitDataService.QueryUnits(asNoTracking: false)
