...
public sealed class AuditController : NodeControllerBase
{
    ...
    public AuditController(AuditReadStore auditReadStore, IWebHostEnvironment environment) : base(environment)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var query = _auditReadStore.QueryAuditLogs().AsQueryable();
    ...
    public async Task<IActionResult> GetAuditLog(int id, CancellationToken cancellationToken)
    {
        ...
        var log = await _auditReadStore.FindAuditLogAsync(id, cancellationToken);
