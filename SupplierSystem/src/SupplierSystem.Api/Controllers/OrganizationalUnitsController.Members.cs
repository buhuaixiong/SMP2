...
public sealed partial class OrganizationalUnitsController
{
    ...
    public async Task<IActionResult> GetMembers(int id, CancellationToken cancellationToken)
    {
        ...
        var unitExists = await _organizationalUnitDataService.QueryUnits()
    ...
    public async Task<IActionResult> AddMembers(int id, [FromBody] JsonElement body, CancellationToken cancellationToken)
    {
        ...
        var existingMembers = await _organizationalUnitDataService.QueryMembers(asNoTracking: false)
        ...
        foreach (var userId in normalizedUserIds)
        {
            ...
            _organizationalUnitDataService.AddMember(new SupplierSystem.Domain.Entities.OrganizationalUnitMember
            {
                TenantId = tenantId,
                UnitId = id,
                UserId = userId,
    ...
    public async Task<IActionResult> RemoveMember(int id, string userId, CancellationToken cancellationToken)
    {
        ...
        var member = await _organizationalUnitDataService.QueryMembers(asNoTracking: false)
        ...
        _organizationalUnitDataService.RemoveMember(member);
        await _organizationalUnitDataService.SaveChangesAsync(cancellationToken);
