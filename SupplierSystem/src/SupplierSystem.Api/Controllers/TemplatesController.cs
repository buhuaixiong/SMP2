...
public sealed class TemplatesController : NodeControllerBase
{
    ...
    private readonly TemplateDocumentStore _templateDocumentStore;
    private readonly IAuditService _auditService;
    private readonly IWebHostEnvironment _environment;
    private readonly ILogger<TemplatesController> _logger;

    public TemplatesController(
        TemplateDocumentStore templateDocumentStore,
    ...
    {
        var active = await _templateDocumentStore.ListActiveAsync(cancellationToken);
    ...
    public async Task<IActionResult> GetTemplateHistory(string code, CancellationToken cancellationToken)
    {
        ...
        var history = await _templateDocumentStore.ListHistoryAsync(definition.Code, cancellationToken);
    ...
    public async Task<IActionResult> UploadTemplate([FromForm] IFormFile? file, [FromForm] string? templateCode, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await using var transaction = await _templateDocumentStore.BeginTransactionAsync(cancellationToken);

            var activeTemplates = await _templateDocumentStore.ListActiveByCodeForUpdateAsync(definition.Code, cancellationToken);
            ...
            _templateDocumentStore.Add(document);
            await _templateDocumentStore.SaveChangesAsync(cancellationToken);
