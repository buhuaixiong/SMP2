...
public sealed partial class ContractsController
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var row = await _contractStore.FindGlobalReminderSettingAsync(asNoTracking: false, cancellationToken);
        ...
        if (row == null)
        {
            ...
            _contractStore.AddReminderSetting(row);
        }
        else
        {
    ...
    {
        var row = await _contractStore.FindGlobalReminderSettingAsync(asNoTracking: true, cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contracts = await _contractStore.QueryContracts()
        ...
        var supplierMap = await _contractStore.LoadSupplierNamesAsync(supplierIds, cancellationToken);
