...
public sealed partial class WarehouseReceiptsController : ApiControllerBase
{
    ...
    private readonly WarehouseReceiptStore _warehouseReceiptStore;

    public WarehouseReceiptsController(WarehouseReceiptStore warehouseReceiptStore)
    {
        _warehouseReceiptStore = warehouseReceiptStore;
    }
}
