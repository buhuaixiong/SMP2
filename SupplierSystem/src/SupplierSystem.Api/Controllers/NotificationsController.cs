...
public sealed class NotificationsController : NodeControllerBase
{
    ...
    public async Task<IActionResult> GetNotifications(CancellationToken cancellationToken)
    {
        ...
        var query = _notificationStore.QueryNotifications();
        ...
        var unreadCount = await _notificationStore.CountUnreadAsync(new AuthScope(user.Id, user.SupplierId), cancellationToken);
    ...
    public async Task<IActionResult> GetUnreadCount(CancellationToken cancellationToken)
    {
        ...
        var count = await _notificationStore.CountUnreadAsync(new AuthScope(user.Id, user.SupplierId), cancellationToken);
    ...
    public async Task<IActionResult> GetNotification(int id, CancellationToken cancellationToken)
    {
        ...
        var notification = await _notificationStore.FindNotificationAsync(id, asNoTracking: true, cancellationToken);
    ...
    public async Task<IActionResult> MarkRead(int id, CancellationToken cancellationToken)
    {
        ...
        var notification = await _notificationStore.FindNotificationAsync(id, asNoTracking: false, cancellationToken);
        ...
        await _notificationStore.SaveChangesAsync(cancellationToken);
    ...
    public async Task<IActionResult> ReadAll(CancellationToken cancellationToken)
    {
        ...
        var now = DateTimeOffset.UtcNow.ToString("o");
        var notifications = await _notificationStore.LoadUnreadNotificationsForUserAsync(new AuthScope(user.Id, user.SupplierId), cancellationToken);
    ...
    public async Task<IActionResult> DeleteNotification(int id, CancellationToken cancellationToken)
    {
        ...
        _notificationStore.RemoveNotification(notification);
        await _notificationStore.SaveChangesAsync(cancellationToken);
    ...
    public async Task<IActionResult> CreateNotification([FromBody] JsonElement body, CancellationToken cancellationToken)
    {
        ...
        var created = await _notificationStore.FindNotificationAsync(createdId.Value, asNoTracking: true, cancellationToken);
