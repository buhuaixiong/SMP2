...
public sealed class EmailSettingsController : ControllerBase
{
    ...
    private readonly EmailSettingsStore _emailSettingsStore;

    public EmailSettingsController(EmailSettingsStore emailSettingsStore)
    {
    ...
    public async Task<IActionResult> GetConfig(CancellationToken cancellationToken)
    {
        ...
        var config = await _emailSettingsStore.LoadConfigAsync(ConfigKey, cancellationToken);
        if (config == null)
        {
            return Ok(new
            {
    ...
    public async Task<IActionResult> UpdateConfig([FromBody] JsonElement body, CancellationToken cancellationToken)
    {
        ...
        var existing = await _emailSettingsStore.LoadConfigAsync(ConfigKey, cancellationToken);
        ...
        await _emailSettingsStore.SaveConfigAsync(
            ConfigKey,
            serialized,
    ...
    public async Task<IActionResult> DeleteConfig(CancellationToken cancellationToken)
    {
        ...
        await _emailSettingsStore.DeleteConfigAsync(ConfigKey, cancellationToken);
