...
public sealed class RfqStatusHistoryEntityConfiguration : IEntityTypeConfiguration<RfqStatusHistory>
{
    public void Configure(EntityTypeBuilder<RfqStatusHistory> builder)
    {
        builder.ToTable("rfq_status_history");
