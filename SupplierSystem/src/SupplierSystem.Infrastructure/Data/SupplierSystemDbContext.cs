...
public sealed class SupplierSystemDbContext : DbContext
{
    ...
    public DbSet<RfqBidRound> RfqBidRounds => Set<RfqBidRound>();
    ...
    public DbSet<ItemMasterRecord> ItemMasterRecords => Set<ItemMasterRecord>();
    public DbSet<ItemMasterImportBatch> ItemMasterImportBatches => Set<ItemMasterImportBatch>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(SupplierSystemDbContext).Assembly);
        ...
        modelBuilder.Entity<ItemMasterRecord>(entity =>
        {
            entity.ToTable("item_master_records");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Fac).HasColumnName("fac");
            entity.Property(e => e.ItemNumber).HasColumnName("item_number");
            entity.Property(e => e.Vendor).HasColumnName("vendor");
            entity.Property(e => e.SourcingName).HasColumnName("sourcing_name");
            entity.Property(e => e.OwnerUserId).HasColumnName("owner_user_id");
            entity.Property(e => e.OwnerUsernameSnapshot).HasColumnName("owner_username_snapshot");
            entity.Property(e => e.ItemDescription).HasColumnName("item_description");
            entity.Property(e => e.Unit).HasColumnName("unit");
            entity.Property(e => e.Moq).HasColumnName("moq");
            entity.Property(e => e.Spq).HasColumnName("spq");
            entity.Property(e => e.Currency).HasColumnName("currency");
            entity.Property(e => e.PriceBreak1).HasColumnName("price_break_1");
            ...
            entity.Property(e => e.TermsDesc).HasColumnName("terms_desc");
            entity.Property(e => e.Company).HasColumnName("company");
            entity.Property(e => e.Class).HasColumnName("class");
            entity.Property(e => e.RawPayload).HasColumnName("raw_payload");
            entity.Property(e => e.CreatedAt).HasColumnName("created_at");
            entity.Property(e => e.UpdatedAt).HasColumnName("updated_at");
            entity.Property(e => e.LastImportBatchId).HasColumnName("last_import_batch_id");

            entity.HasIndex(e => new { e.Fac, e.ItemNumber, e.Vendor })
                .IsUnique()
                .HasDatabaseName("UX_item_master_records_fac_item_vendor");
            entity.HasIndex(e => e.OwnerUserId)
                .HasDatabaseName("IX_item_master_records_owner_user_id");
            entity.HasIndex(e => e.SourcingName)
                .HasDatabaseName("IX_item_master_records_sourcing_name");
            entity.HasIndex(e => e.Fac)
                .HasDatabaseName("IX_item_master_records_fac");
        });

        modelBuilder.Entity<ItemMasterImportBatch>(entity =>
        {
            entity.ToTable("item_master_import_batches");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.FileName).HasColumnName("file_name");
            entity.Property(e => e.SheetScope).HasColumnName("sheet_scope");
            entity.Property(e => e.Status).HasColumnName("status");
            entity.Property(e => e.StartedAt).HasColumnName("started_at");
            entity.Property(e => e.FinishedAt).HasColumnName("finished_at");
            entity.Property(e => e.ImportedByUserId).HasColumnName("imported_by_user_id");
            entity.Property(e => e.ImportedByName).HasColumnName("imported_by_name");
            ...
            entity.Property(e => e.WarningsJson).HasColumnName("warnings_json");
            entity.Property(e => e.ErrorsJson).HasColumnName("errors_json");
        });
    ...
    private static void ApplyNumericConventions(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<RfqPriceAuditRecord>()
            ...
            .HasColumnType("bigint");
        modelBuilder.Entity<ItemMasterRecord>()
            .Property(r => r.Id)
            .HasColumnType("bigint");
        modelBuilder.Entity<ItemMasterRecord>()
            .Property(r => r.LastImportBatchId)
            .HasColumnType("bigint");
        modelBuilder.Entity<ItemMasterImportBatch>()
            .Property(r => r.Id)
            .HasColumnType("bigint");
