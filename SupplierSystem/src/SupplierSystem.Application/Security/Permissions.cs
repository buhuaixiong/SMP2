...
public static class Permissions
{
    ...
    public const string ItemMasterViewOwn = "item_master.view.own";
    ...
    public const string ItemMasterImportManage = "item_master.import.manage";
    public const string ItemMasterViewAll = "item_master.view.all";
