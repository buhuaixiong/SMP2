...
public sealed class ApprovalPreviewRequest
{
...
public sealed class ApprovalPreviewResponse
{
    ...
    public List<ApprovalPreviewStepResponse> Steps { get; set; } = new();
    public List<ApprovalRiskFlagResponse> RiskFlags { get; set; } = new();
    public List<string> CategoryAChanges { get; set; } = new();
    public bool RequiresTempAccount { get; set; }
    public Dictionary<string, object?> ChangeSummary { get; set; } = new();
    public string GeneratedAt { get; set; } = string.Empty;
}

public sealed class ApprovalPreviewStepResponse
{
...
public sealed class ApprovalRiskFlagResponse
{
    public string Key { get; set; } = string.Empty;
...
public sealed class IssueTempAccountRequest
{
    public string? Currency { get; set; }
    public int? ExpiresInDays { get; set; }
    public string? ExpiresAt { get; set; }
    public bool ForceReissue { get; set; }
    public string? Password { get; set; }
}

public sealed class TempAccountResponse
{
    public int SupplierId { get; set; }
...
public sealed class FinalizeSupplierCodeRequest
{
    [Required]
    public string? SupplierCode { get; set; }
    public string? Password { get; set; }
...
public sealed class FinalizeSupplierCodeResponse
{
    public int SupplierId { get; set; }
...
public sealed class SupplierBenchmarksResponse
{
    public int TotalSuppliers { get; set; }
    public int ApprovedSuppliers { get; set; }
    public double ApprovalRate { get; set; }
    public double AverageCompletionScore { get; set; }
    public SupplierBenchmarkStatusBreakdown ByStatus { get; set; } = new();
    public List<SupplierBenchmarkBucket> ByCategory { get; set; } = new();
    public List<SupplierBenchmarkBucket> ByRegion { get; set; } = new();
}

public sealed class SupplierBenchmarkStatusBreakdown
{
...
public sealed class SupplierBenchmarkBucket
{
    public string Key { get; set; } = string.Empty;
