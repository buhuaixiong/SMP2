...
public interface ISupplierService
{
    ...
    /// 预览审批流程
    /// </summary>
    Task<ApprovalPreviewResponse> PreviewApprovalAsync(ApprovalPreviewRequest request, CancellationToken cancellationToken);
    ...
    /// 发行临时账户
    /// </summary>
    Task<TempAccountResponse> IssueTempAccountAsync(int supplierId, IssueTempAccountRequest request, CancellationToken cancellationToken);

    /// <summary>
    /// 确定供应商代码
    /// </summary>
    Task<FinalizeSupplierCodeResponse> FinalizeSupplierCodeAsync(
        int supplierId,
    ...
    /// 获取供应商基准数据
    /// </summary>
    Task<SupplierBenchmarksResponse> GetBenchmarksAsync(CancellationToken cancellationToken);
