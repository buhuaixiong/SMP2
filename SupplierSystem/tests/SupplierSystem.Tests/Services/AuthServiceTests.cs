...
public class AuthServiceTests
{
    ...
    [Fact]
    public void ResolveSecret_WithEnvAndConfigured_ShouldReturnEnvValue()
    {
        // Act
        var result = InvokeResolveSecret("configured-secret", "env-secret");
    ...
    [Fact]
    public void ResolveSecret_WithEmptyEnvAndConfigured_ShouldReturnConfigured()
    {
        // Act
        var result = InvokeResolveSecret("configured-secret", "");

        // Assert
        result.Should().Be("configured-secret");
    }

    [Fact]
    public void ResolveSecret_WithPlaceholderConfigured_ShouldReturnEnvValue()
    {
        // Act
    ...
    {
        var methodInfo = typeof(AuthService).GetMethod(
            "ResolveSecret",
