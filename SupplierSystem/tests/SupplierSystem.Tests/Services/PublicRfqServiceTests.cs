...
public class PublicRfqServiceTests
{
    ...
    [Fact]
    public void ResolveSecret_WithEmptyEnvAndValidConfigured_ShouldReturnConfigured()
    {
        // Act
        var result = InvokeResolveSecret("valid-secret", "");
    ...
    {
        // Arrange & Act
        var user = new PublicAutoLoginUser("user1", "John Doe", "supplier", 1, true);
    ...
    {
        // Arrange & Act
        var user = new PublicAutoLoginUser("user1", "John Doe", "supplier", null, false);
    ...
    {
        // Arrange
        var user = new PublicAutoLoginUser("user1", "John", "supplier", 1, false);
