...
public class ControllerBasicTests
{
    ...
    public void RfqWorkflowController_CanBeCreated()
    {
        ...
        var comparisonPrintService = new SupplierSystem.Api.Services.Rfq.RfqComparisonPrintService(
            dbContext,
            new SupplierSystem.Api.Services.Rfq.RfqWorkflowStore(dbContext),
            new SupplierSystem.Api.Services.Audit.AuditReadStore(dbContext));
