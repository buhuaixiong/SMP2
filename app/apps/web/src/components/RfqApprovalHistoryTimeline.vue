...
function getTimelineType(decision: string): 'success' | 'danger' | 'primary' | 'info' {
...
function getTimelineIcon(decision: string): Component | undefined {
...
function getDecisionType(decision: string): 'success' | 'danger' | 'primary' | 'info' {
  const typeMap: Record<string, 'success' | 'danger' | 'primary' | 'info'> = {
    approved: 'success',
    rejected: 'danger',
    confirmed: 'success',
