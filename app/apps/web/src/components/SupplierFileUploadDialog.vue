...
import type { FormInstance, FormItemRule, UploadFile, UploadInstance } from "element-plus";
...
const formRules = {
  ...
  validTo: [
    ...
    {
      validator: (_rule: FormItemRule, value: string, callback: ValidatorCallback) => {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    notification.error(extractErrorMessage(error) || "文件上传失败,请稍后重试");
  } finally {
