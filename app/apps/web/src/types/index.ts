...
export interface RfqBidRoundSummary {
  id: number;
  rfqId?: number;
  roundNumber: number;
  ...
  startedFromRoundId?: number | null;
}

export interface RfqRoundHistoryEntry {
  summary: RfqBidRoundSummary | null;
  invitedSuppliers: RfqInvitedSupplier[];
  quotes: Quote[];
  priceComparisons: Array<QuotePriceComparison | Record<string, unknown>>;
  externalInvitations?: ExternalSupplierInvitation[] | Record<string, unknown>[];
}

export interface RfqSupplierComparisonHistory {
  rfqId: number;
  title?: string | null;
  currentRoundId?: number | null;
  latestRoundId?: number | null;
  rounds: RfqRoundHistoryEntry[];
}
...
export interface RfqComparisonPrintSupplierSummaryRow {
...
export interface RfqComparisonPrintQuoteRow {
  roundNumber?: number | null;
...
export interface RfqComparisonPrintAuditRow {
  roundNumber?: number | null;
...
export type RfqComparisonPrintScope = "latest" | "all";

export interface ExtendRfqBidDeadlinePayload {
  newDeadline: string;
  reason?: string | null;
}

export interface StartNextRfqBidRoundPayload {
  deadline: string;
  reason?: string | null;
  supplierIds: number[];
}

export interface RfqComparisonPrintRoundGroup {
  roundId?: number | null;
  roundNumber: number;
  status?: string | null;
  bidDeadline?: string | null;
  ...
  withdrawnSupplierCount: number;
  supplierSummary: RfqComparisonPrintSupplierSummaryRow[];
  quoteRows: RfqComparisonPrintQuoteRow[];
}

export interface RfqComparisonPrintData {
  rfqId: number;
  scope?: RfqComparisonPrintScope;
  title: string | null;
  status: string | null;
  ...
  requestingDepartment: string | null;
  description: string | null;
  selectedSupplierSummary: string | null;
  invitedSupplierCount: number;
  submittedSupplierCount: number;
  withdrawnSupplierCount: number;
  currentRound?: RfqBidRoundSummary | null;
  latestRound?: RfqBidRoundSummary | null;
  supplierSummary: RfqComparisonPrintSupplierSummaryRow[];
  quoteRows: RfqComparisonPrintQuoteRow[];
  auditRows: RfqComparisonPrintAuditRow[];
  roundGroups?: RfqComparisonPrintRoundGroup[];
}
