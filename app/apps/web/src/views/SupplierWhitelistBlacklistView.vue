...
const loadWhitelistData = async () => {
  ...
  try {
    ...
    notification.error(extractErrorMessage(error) || t("whitelistBlacklist.whitelist.messages.loadFailed"));
  } finally {
...
const loadSuppliers = async () => {
  ...
  try {
    ...
    notification.error(extractErrorMessage(error) || "加载供应商列表失败");
  } finally {
...
const submitWhitelistForm = async () => {
  ...
  await whitelistFormRef.value.validate(async (valid) => {
    ...
    try {
      ...
      notification.error(extractErrorMessage(error) || t("whitelistBlacklist.whitelist.messages.addFailed"));
    } finally {
...
const handleDeactivateWhitelist = async (id: number) => {
  try {
    ...
    if (error !== "cancel") {
      notification.error(extractErrorMessage(error) || t("whitelistBlacklist.whitelist.messages.deactivateFailed"));
    }
  }
};
...
const handleDeleteWhitelist = async (id: number) => {
  try {
    ...
    if (error !== "cancel") {
      notification.error(extractErrorMessage(error) || t("whitelistBlacklist.whitelist.messages.deleteFailed"));
    }
  }
};
...
const loadBlacklistData = async () => {
  ...
  try {
    ...
    notification.error(extractErrorMessage(error) || t("whitelistBlacklist.blacklist.messages.loadFailed"));
  } finally {
...
const submitBlacklistForm = async () => {
  ...
  await blacklistFormRef.value.validate(async (valid) => {
    ...
    try {
      ...
      notification.error(extractErrorMessage(error) || t("whitelistBlacklist.blacklist.messages.addFailed"));
    } finally {
...
const handleDeactivateBlacklist = async (id: number) => {
  try {
    ...
    if (error !== "cancel") {
      notification.error(extractErrorMessage(error) || t("whitelistBlacklist.blacklist.messages.deactivateFailed"));
    }
  }
};
...
const handleDeleteBlacklist = async (id: number) => {
  try {
    ...
    if (error !== "cancel") {
      notification.error(extractErrorMessage(error) || t("whitelistBlacklist.blacklist.messages.deleteFailed"));
    }
  }
};
