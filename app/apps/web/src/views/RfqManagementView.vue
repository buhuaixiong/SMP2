    ...
    <template v-else>
      ...
      <el-card class="filter-card" shadow="never">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item :label="t('rfq.filter.title')">
            <el-input
              v-model="filters.keyword"
              :placeholder="t('rfq.filter.titlePlaceholder')"
              clearable
          ...
          <el-form-item>
            <el-checkbox v-model="showOnlyMine">{{ t('rfq.filter.selfPublished') }}</el-checkbox>
          </el-form-item>
...
async function loadRfqs() {
  ...
  loading.value = true;
  try {
    const createdBy = showOnlyMine.value ? authStore.user?.id : undefined;
...
async function loadPendingRfqLineItems() {
  ...
  try {
    ...
    pendingRfqLineItemsError.value =
      extractErrorMessage(error) || t("rfq.management.pendingLineItems.loadError");
  } finally {
...
async function loadSupplierInvitations() {
  ...
  try {
    ...
    supplierInvitationsError.value = extractErrorMessage(error) || t("rfq.management.loadError");
  } finally {
