...
type NotificationOptionsInput = Partial<NotificationOptions> & {
...
const toNotificationOptionsInput = (value: NotificationParams): NotificationOptionsInput =>
  value as NotificationOptionsInput;

const toMessageOptionsInput = (value: MessageParams): MessageParams => value;
    ...
    return {
      success(messageOrOptions: string | NotificationParams, title?: string, options?: Partial<NotificationOptions>): void {
        if (typeof messageOrOptions === 'string') {
          ...
          const params = toNotificationOptionsInput(messageOrOptions);
      ...
      message(textOrOptions: string | MessageParams, type: NotificationType = "info", options?: MessageParams): void {
        if (typeof textOrOptions === 'string') {
          if (options) {
            const messageOptions = toMessageOptionsInput(options) as Record<string, unknown>;
            ElMessage({
